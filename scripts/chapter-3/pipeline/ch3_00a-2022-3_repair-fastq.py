...
if __name__ == "__main__":
    ...
    pairscript = here("./scripts/other/fastqCombinePairedEnd.py")

    # September run of PECO 2023
    fastqDirectory = here("./rawdata/peco/fastq/miseq_nextseq/miseq_2022_run2/fixed")
    singlesDirectory = here("./rawdata/peco/fastq/miseq_nextseq/miseq_2022_run2/fixed/singles/")
    originalsDirectory = here("./rawdata/peco/fastq/miseq_nextseq/miseq_2022_run2/fixed/improperlypaired/")
    ...
    # September run of PECO 2023
    fastqDirectory2 = here("./rawdata/peco/fastq/miseq_nextseq/nextseq_2022_run2/fixed")
    singlesDirectory2 = here("./rawdata/peco/fastq/miseq_nextseq/nextseq_2022_run2/fixed/singles/")
    originalsDirectory2 = here("./rawdata/peco/fastq/miseq_nextseq/nextseq_2022_run2/fixed/improperlypaired/")

    #
    pairfastqs(fastqDirectory2)
    runPairScript(fastqDirectory2, pairscript)
    sortPairs(fastqDirectory2, singlesDirectory2, originalsDirectory2)
    renamePairs(fastqDirectory2, originalsDirectory2)
