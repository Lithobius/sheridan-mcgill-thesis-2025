...
bcfishbase <- read_csv(here(splists,
                        '20251212_obis-fish_fishbase_bc.csv'))[-1] 


npfish <- read_csv(here(splists, '20251212_fishlist_obis-hakai.csv'))[-1] %>%
  select(species) %>%
...
just comment and uncomment what comparisons to see
...
ggsave(here('output', 'chapter1', 'splist_compare', 
            paste0(datefield, 'families-not-in-blast.png')), last_plot(), device = 'png')
...
ggsave(here('output', 'chapter1', 'splist_compare',
            paste0(datefield, 'familes-not-in-blast_10.png')), last_plot(), device = 'png')
...
ggsave(here('output', 'chapter1', 'splist_compare', 
            paste0(datefield, 'orders-not-in-blast_10.png')), last_plot(), device = 'png')
```
...
ggsave(here('output', 'chapter1', 'splist_compare',
            paste0(datefield, 'families-not-in-blast_flip.png')), 
       last_plot(), 
       device = 'png',
       width = 6,
       height = 4,
...
ggsave(here('output', 'chapter1', 'splist_compare',
            paste0(datefield, '20231114_families-not-in-blast_flip.pdf')), 
       last_plot(), 
       device = 'pdf',
       width = 6,
       height = 4,
