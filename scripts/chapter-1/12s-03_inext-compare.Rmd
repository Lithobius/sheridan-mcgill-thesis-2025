...
ggsave(here('output', 'splist_compare', paste0(datefield, 'asv-vs-motu.pdf')), 
...
ggsave(here('output', 'splist_compare', paste0(datefield, 'asv-vs-motu-cn.pdf')), 
       last_plot(), device = 'pdf', 
...
ggsave(here('output', 'splist_compare', paste0(datefield, 'asv-vs-motu_top-n-cn.pdf')), 
       last_plot(), device = 'pdf', 
       width = 6, 
       height = 5, 
       units = 'in')
