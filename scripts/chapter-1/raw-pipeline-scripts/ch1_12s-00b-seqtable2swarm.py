...
if __name__ == "__main__":
    ...
    ## 12s
    asvmatrix_in = here('./rawdata/2018calvert/fastq/12S_Calvert2018_Re-run20210903/processed/20240315_12s_2018calvert_rerun20210903_sequence-table_12S-merged-w-ASV-names.txt')
    ## COI
    #asvmatrix_in = here('./rawdata/2018calvert/COI/sequence_table.CO1.merged.corrected_ASV_names.collapsed.txt')
    asv_values = asv_abund(asvmatrix_in)
    # input FASTA
    fasta_in = here("./rawdata/2018calvert/fastq/12S_Calvert2018_Re-run20210903/processed/20240315_12s_2018calvert_rerun20210903_12S-ASV-sequences.fasta")
    # output FASTA
    fasta_out = here("./rawdata/2018calvert/fastq/12S_Calvert2018_Re-run20210903/processed/20240315_calvert2018_12s_sequence-table_swarm-format.fasta")
