...
if __name__ == "__main__":
    ...
    ## 12s
    asvmatrix_in = here('./rawdata/2018calvert/fastq/coi_kate/combined_runs/20240205_2018calvert_coi_sequence-table_asv-names.txt')
    ## COI
    ...
    # input FASTA
    fasta_in = here('./rawdata/2018calvert/fastq/coi_kate/combined_runs/20240205_2018calvert_coi_asv-sequences.fasta')
    # output FASTA
    fasta_out = here('./rawdata/2018calvert/fastq/coi_kate/combined_runs/20240219_calvert2018_coi_sequence-table_swarm-format.fasta')
