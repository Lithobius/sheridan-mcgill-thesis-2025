...
LOG_FILENAME = 'repairfastqloop-log.txt'
...
if __name__ == "__main__":
    ...
    # Genome quebec Sept 23
    #fastqDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Sept232019_2/")
    #singlesDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Sept232019_2/singles")
    #originalsDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Sept232019_2/improperlypaired")

    # Genome quebec Oct 21
    fastqDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Oct212019_2/")
    singlesDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Oct212019_2/singles/")
    originalsDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_GenomeQuebec_Oct212019_2/improperlypaired/")

    # Quadra Run1
    #fastqDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_Training_03062020-Quadra/")
    #singlesDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_Training_03062020-Quadra/singles/")
    #originalsDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_Run1_Training_03062020-Quadra/improperlypaired/")

    # Quadra ReRun3
    #fastqDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_ReRun3_04062020-Quadra/")
    #singlesDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_ReRun3_04062020-Quadra/singles/")
    #originalsDirectory = here("./rawdata/2018calvert/fastq/coi_kate/CO1_ReRun3_04062020-Quadra/improperlypaired/")
