...
if __name__ == "__main__":
    ...
    direct = here('./rawdata/peco/fastq/12S_PECO_2022_Redos_Run20250301/Analysis/1/Data/fastq/fixed')
    ...
    # list for empties
    empties_list = here('./rawdata/peco/fastq/12S_PECO_2022_Redos_Run20250301/Analysis/1/Data/fastq/fastq_w_no_sequences.txt')
