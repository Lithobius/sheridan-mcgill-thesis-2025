...
if __name__ == "__main__":
    ...
    ## 12s
    asv2motu_key = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_swarm_statsfile-w-motunums.csv')
    motu_converted = asv2motu(asv2motu_key)
    # input FASTA
    fasta_in = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_swarm_clusterreps.fasta')
    # output FASTA
    fasta_out = here("./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_swarm_clusterreps-motus.fasta")
