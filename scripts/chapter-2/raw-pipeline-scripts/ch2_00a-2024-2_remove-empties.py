...
LOG_FILENAME = 'remove2024-log.txt'
...
if __name__ == "__main__":
    ...
    direct = here('./rawdata/peco/fastq/12S_PECO2024_20250525/Analysis/1/Data/fastq/fixed')
    # destination directory for 'good' files
    dest_direct = here('./rawdata/peco/fastq/12S_PECO2024_20250525/Analysis/1/Data/fastq/fixed/empty')
    # list for empties
    empties_list = here('./rawdata/peco/fastq/12S_PECO2024_20250525/Analysis/1/Data/fastq/fastq_w_no_sequences.txt')
