...
LOG_FILENAME = 'rename2021-log.txt'
...
if __name__ == "__main__":
    ...
    direct = here('./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/')
    # destination directory for 'good' files
    dest_direct = here('./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fixed/')
    ## csv of replacements
    replacements = here('./rawdata/peco/2021_edna/peco_2021_name-replacement-nextseq.csv')
