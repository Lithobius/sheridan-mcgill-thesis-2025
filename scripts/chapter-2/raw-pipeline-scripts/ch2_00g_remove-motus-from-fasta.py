...
if __name__ == "__main__":
    ...
    asvlist = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_removed-motus.csv')
    # input FASTA
    fasta = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_swarm_clusterreps-motus.fasta')
    new_fasta = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_post-lulu-motus.fasta')
    # run fasta function
