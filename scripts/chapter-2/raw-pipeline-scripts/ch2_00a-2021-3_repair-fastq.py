...
LOG_FILENAME = 'repairfastqloop2021-log.txt'
...
if __name__ == "__main__":
    ...
    fastqDirectory = here("./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fixed")
    singlesDirectory = here("./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fixed/singles/")
    originalsDirectory = here("./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fixed/improperlypaired/")
