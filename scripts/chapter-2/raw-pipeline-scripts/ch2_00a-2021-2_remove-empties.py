...
LOG_FILENAME = 'remove2021-log.txt'
...
if __name__ == "__main__":
    ...
    direct = here('./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fixed')
    ...
    # list for empties
    empties_list = here('./rawdata/peco/fastq/12S_PECO_2021_Redos_Run20250416/Analysis/1/Data/fastq/fastq_w_no_sequences.txt')
