...
if __name__ == "__main__":
    ...
    ## 12s
    asvmatrix_in = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_sequence-table_asv-names.txt')
    asv_values = asv_abund(asvmatrix_in)
    # input FASTA
    fasta_in = here('./rawdata/peco/fastq/allyears/20250528_peco-combined_12s_asv-sequences.fasta')
    # output FASTA
    fasta_out = here("./rawdata/peco/fastq/allyears//20250528_peco-combined_12s_sequence-table_swarm-format.fasta")
