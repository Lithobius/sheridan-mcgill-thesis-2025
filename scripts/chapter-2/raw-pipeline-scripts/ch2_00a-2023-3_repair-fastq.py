...
if __name__ == "__main__":
    ...
    fastqDirectory = here("./rawdata/peco/fastq/12S_PECO2023_Run20240907/Analysis/1/Data/fastq/fixed")
    singlesDirectory = here("./rawdata/peco/fastq/12S_PECO2023_Run20240907/Analysis/1/Data/fastq/fixed/singles/")
    originalsDirectory = here("./rawdata/peco/fastq/12S_PECO2023_Run20240907/Analysis/1/Data/fastq/fixed/improperlypaired/")
