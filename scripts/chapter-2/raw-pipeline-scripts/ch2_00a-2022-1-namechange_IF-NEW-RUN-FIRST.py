...
if __name__ == "__main__":
    ...
    direct = here('./rawdata/peco/fastq/12S_PECO_2022_Redos_Run20250301/Analysis/1/Data/fastq/')
    # destination directory for 'good' files
    dest_direct = here('./rawdata/peco/fastq/12S_PECO_2022_Redos_Run20250301/Analysis/1/Data/fastq/fixed/')
    ## csv of replacements
    replacements = here('./rawdata/peco/2022_edna/peco_2022_name-replacement-nextseq.csv')
