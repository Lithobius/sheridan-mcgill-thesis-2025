...
"""
getting error from cutadapt from the fastq for improperly paired reads.
The names of the attempted pairings in the file are totally different so I believe there are orphaned reads within the files. This script reasolves the error.

I am modifying this script from: https://github.com/enormandeau/Scripts/blob/master/fastqCombinePairedEnd.py
Any changes have been commented
2024 Jan: No changes
...
LOG_FILENAME = 'repairfastq-log.txt'
